...
class MockSmsTwilioApi(SMSCase):
    ...
    def setUpClass(cls):
        ...
        cls.twilio_request_re = re.compile(r"https://api.twilio.com/2010-04-01/Accounts/([^/]+)/(.*)")
        ...
        cls.request_send_ok_json = {
            "account_sid": "dummy_twilio_account_sid",
    ...
    def _setup_sms_twilio(cls, company):
        company.sudo().write({
            "sms_provider": "twilio",
            "sms_twilio_account_sid": "dummy_twilio_account_sid",
