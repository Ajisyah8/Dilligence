...
class SlideSlide(models.Model):
    ...
    @api.depends('slide_category', 'source_type', 'binary_content', 'google_drive_id', 'video_source_type', 'youtube_id', 'vimeo_id')
            ...
            if slide.slide_category == 'audio' and slide.source_type == 'local_file' and slide.binary_content:
                ...
                if slide.source_type == 'local_file' and slide.binary_content:
                    ...
                    base_video_tag = Markup(
                        '<video controls="controls" preload="metadata" class="w-100 h-100" aria-label="%s">'
                        '<source src="%s"></source>'
                        '</video>'
                    )
