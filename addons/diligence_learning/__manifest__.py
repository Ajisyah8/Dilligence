{
    ...
    'data': [
        ...
        'views/contact_segment_views.xml',
        ...
        'web.assets_frontend': [
            ...
            'diligence_learning/static/src/xml/diligence_fullscreen_descriptions.xml',
            'diligence_learning/static/src/xml/diligence_quiz_create.xml',
            'diligence_learning/static/src/scss/course_detail.scss',
            'diligence_learning/static/src/scss/diligence_unified_video_player.scss',
